...
import {EditWorkplaceGeneralData} from "../workplaceModule/component/EditWorkplaceGeneralData";
import {EditHealthAndSafetyPolicyGeneralData} from "./component/EditHealthAndSafetyPolicyGeneralData";

export const EditHealthAndSafetyPolicyPage = () => {
    const {id} = useParams();
                ...
                <Container fluid>
                    <Row>
                        <Col lg={12}>
                            <Card>
                                <CardBody>
                                    <CardTitle className="h4">Política de Seguridad y Salud en el Trabajo </CardTitle>
